...
dateadd(second, SEM_AGENT.LAST_UPDATE_TIME/1000, '1970-01-01') AS 'Last check-in (GMT)', SEM_AGENT.AGENT_VERSION, SEM_COMPUTER.OPERATION_SYSTEM
FROM SEM_COMPUTER
...
GROUP BY SEM_COMPUTER.COMPUTER_NAME, SEM_AGENT.LAST_UPDATE_TIME, PATTERN.Version, SEM_AGENT.AGENT_VERSION, SEM_COMPUTER.OPERATION_SYSTEM
ORDER BY SEM_COMPUTER.COMPUTER_NAME ASC, SEM_AGENT.LAST_UPDATE_TIME DESC;
OUTPUT TO "D:\Task-Export\hosts_status.csv"